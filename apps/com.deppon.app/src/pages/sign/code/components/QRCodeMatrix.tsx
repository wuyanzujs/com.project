...
const QRCodeMatrix = ({
  value,
  size = APP_NATIVE_TOKENS.qr.defaultSize,
  darkColor = APP_STYLE_COLORS.text.strong,
  lightColor = APP_STYLE_COLORS.surface.card,
  ...
  const moduleSize = Math.max(
    APP_NATIVE_TOKENS.qr.minimumModuleSize,
    Math.floor(size / matrix.length)
  )
