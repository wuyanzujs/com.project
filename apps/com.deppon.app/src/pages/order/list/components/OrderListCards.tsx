...
export function OrderCard(props: {
  ...
  const hasActions = cancelable || deletable || resendable
    ...
    <View className='order-card'>
      ...
      >
        <View className='order-card__top'>
          <Text className='order-card__status'>{props.order.orderClassName}</Text>
  ...
  return (
    <View className='order-list-content'>
      ...
      {!props.orders.length && !props.loading && (
        <OrderListEmpty title={props.errorMessage || '暂无订单'} />
      )}
